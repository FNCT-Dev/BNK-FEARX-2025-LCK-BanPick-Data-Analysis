...
## Step 1. 상대 팀의 대 BFX전 데이터 추출 및 정제
...
### Step 2.1. 상대 팀의 대 BFX전 상위 30개 밴 횟수 및 밴률 그래프
...
## Step 3. 상대 팀의 대 BFX전 포지션별 픽 데이터 추출
...
### Step 3.1. 대 BFX전 포지션별 픽률 및 승률 그래프
...
### Step 2.1. BFX전 종합 상위 30개 밴 횟수 및 밴률 그래프
...
## Step 2. BFX전 상대 진영 별 픽 데이터

### Step 2.1. 블루 진영 기준 모스트 픽 및 1픽

#### Step 2.1.1. BFX 시점 데이터 추출
...
##### Step 2.1.1.1. BFX 시점 블루 진영 전체 모스트 픽 데이터
...
###### Step 2.1.1.1.1. BFX 시점 블루 진영 전체 모스트 픽 그래프
...
##### Step 2.1.1.2. BFX 시점 블루 진영 1픽 모스트 픽 데이터
...
###### Step 2.1.1.2.1. BFX 시점 블루 진영 1픽 모스트 픽 그래프
...
##### Step 2.1.2.1. 상대 팀 시점 블루 진영 전체 모스트 픽
...
###### Step 2.1.2.1.1. 상대 팀 시점 블루 진영 전체 모스트 픽 그래프
...
##### Step 2.1.2.2. 상대 팀 시점 블루 진영 1픽 모스트 픽
...
###### Step 2.1.2.2.1. 상대 팀 시점 블루 진영 1픽 모스트 픽 그래프
...
##### Step 2.1.3.1. BFX전 종합 블루 진영 전체 모스트 픽
...
###### Step 2.1.2.1.1. BFX전 종합 블루 진영 전체 모스트 픽 그래프
...
##### Step 2.1.2.2. BFX전 종합 블루 진영 1픽 모스트 픽
...
###### Step 2.1.2.2.1. BFX전 종합 블루 진영 1픽 모스트 픽 그래프
...
##### Step 2.1.1.1. BFX 시점 레드 진영 전체 모스트 픽 데이터
...
###### Step 2.1.1.1.1. BFX 시점 레드 진영 전체 모스트 픽 그래프
...
##### Step 2.1.1.2. BFX 시점 레드 진영 1픽 모스트 픽 데이터
...
###### Step 2.1.1.2.1. BFX 시점 레드 진영 1픽 모스트 픽 그래프
...
##### Step 2.1.2.1. 상대 팀 시점 레드 진영 전체 모스트 픽
...
###### Step 2.1.2.1.1. 상대 팀 시점 레드 진영 전체 모스트 픽 그래프
...
##### Step 2.1.2.2. 상대 팀 시점 레드 진영 1픽 모스트 픽
...
###### Step 2.1.2.2.1. 상대 팀 시점 레드 진영 1픽 모스트 픽 그래프
...
##### Step 2.1.3.1. BFX전 종합 레드 진영 전체 모스트 픽
...
###### Step 2.1.2.1.1. BFX전 종합 레드 진영 전체 모스트 픽 그래프
...
##### Step 2.1.2.2. BFX전 종합 레드 진영 1픽 모스트 픽
...
###### Step 2.1.2.2.1. BFX전 종합 레드 진영 1픽 모스트 픽 그래프
